...
interface BasicTableFilterOptionsProps<TData> {
  table: Table<TData>;
}

export function BasicTableFilterOptions<TData>({
  table,
}: BasicTableFilterOptionsProps<TData>) {
        ...
        <div className="flex flex-col gap-1">
          ...
          >
            <div className={`flex items-center justify-center w-4 h-4 rounded ${
              ...
              {visibleColumnIds.size === columns.length && <Check size={14} strokeWidth={2} />}
            </div>
            ...
            return (
              ...
              >
                <div className={`flex items-center justify-center w-4 h-4 rounded ${
                  ...
                  {isVisible && <Check size={14} strokeWidth={2} />}
                </div>
